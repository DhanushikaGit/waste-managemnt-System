...
<head>
    ...
    <title>About Us - Trash Truce</title>
...
<body>
    <main>
        <section id="about-us">
            <div class="content">
                <h2>Welcome To the Trash Truce</h2>
                <h1>About Us</h1>
                <p>Kandy Municipal Council was established under Ordinance No.17 of 1865. It's inaugural meeting was held on 20th March 1866. A Panel of Judges was appointed to go into cases where By-laws were violated. Those powers were transferred over to the Municipal Magistrate by Ordinance No.7 of 1887.
                  ...
                  Municipal Office was started at the present premises in March, 1870. Presently the Council is made up of 24 elected members.</p>
                
            </div>
            <div class="image">
                <img src="image/844.jpg" alt="Trash Truce Image">
            </div>
        </section>
    </main>
<?php
